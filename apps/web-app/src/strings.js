...
export const strings = {
  ...
  admin: {
    ...
    retrain: {
      ...
      metricsLabel: {
        rmse: "RMSE huấn luyện (in-sample)",
        mae: "MAE huấn luyện (in-sample)",
        r2: "R² huấn luyện (in-sample)",
        feature_count: "Số feature",
        ml_service_reload: "Hot-reload ml-service",
      },
      promotedYes: "Đã áp dụng (model mới đang chạy)",
      promotedNo: "Không áp dụng — giữ model cũ",
      promotionReasonLabel: "Lý do",
      testMetricsHeading: "Tập kiểm thử (H3 hold-out — không rò rỉ)",
      testRmse: "RMSE kiểm thử (dB)",
      testMae: "MAE kiểm thử (dB)",
      testR2: "R² kiểm thử",
      testBias: "Bias kiểm thử (dB)",
      testN: "Số điểm kiểm thử",
